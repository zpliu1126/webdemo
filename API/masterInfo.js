...
function addMessage(body, callback) {
  ...
  poolConnection.getConnection(function (err, connection) {
    ...
    sql = `
  INSERT INTO masterInfo(name,interest,honor,teacherId,tel,sex,school,transcript,studentExperience,searchExperience,imgUrl)
...
/*上传学生个人图片API */
router.post("/mster/img", uploadPath.single('file'), function (req, rep) {
