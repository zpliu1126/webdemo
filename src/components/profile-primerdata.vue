<template>
  <el-main>
  <el-row>
    <el-col :xs="12" :sm="6" :span="6"><el-button  type="warning"  @click="handleUpdataPrimer">Update</el-button></el-col>
    <el-col :xs="12" :sm="6" :span="6"><el-button type="danger" @click="handleDeletePrimer">Delete</el-button></el-col>
  </el-row>
